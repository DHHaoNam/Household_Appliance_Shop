                    ...
                    <div class="col-md-9">
                        <div class="account-info">
                            ...
                            <div class="info-item">
                                ...
                                <input type="text" id="username" value="${sessionScope.acc.username}" readonly>
                            </div>
                            <div class="info-item">
                                <label for="username">Password:</label>
                                <input type="text" id="password" value="${sessionScope.acc.password}" readonly>
                            </div>
                            <div class="info-item">
                                <label for="email">Email:</label>
                                <input type="email" id="email" value="${sessionScope.acc.email}" readonly>
                            </div>
                            <div class="info-item">
                                <label for="phone">Số điện thoại:</label>
                                <input type="text" id="phone_number" value="${sessionScope.acc.phone_number}" readonly>
                            </div>
